                    ...
                    <div class="card-body">
                        <div class="row gy-4">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade show active" id="locale-en">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name[en]" id="name_en" class="form-control" placeholder="Enter brand name in English"
                                                value="{{ old('name.en', optional($translations->get('en'))->name) }}">
                                            @error('name.en')
                                    ...
                                    <div class="tab-pane fade" id="locale-es">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name[es]" class="form-control" placeholder="Enter brand name in Spanish"
                                                value="{{ old('name.es', optional($translations->get('es'))->name) }}">
                                            @error('name.es')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="slug" id="slug" class="form-control" placeholder="Auto-generated from English name" value="{{ old('slug', $brand->slug) }}" readonly>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                @if ($brand->image)
                                    <div class="mb-2">
                                        <img src="{{ asset($brand->image) }}" alt="Brand Image" width="80" height="80" style="object-fit:cover; border-radius:4px;">
                                    </div>
                                @endif
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" name="status" id="statusSelect">
                                    ...
                                    <option value="1" {{ old('status', $brand->status) == 1 ? 'selected' : '' }}>Published</option>
                                    <option value="0" {{ old('status', $brand->status) == 0 ? 'selected' : '' }}>Unpublished</option>
                                </select>
                                @error('status')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
